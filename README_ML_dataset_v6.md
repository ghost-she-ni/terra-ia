# Terra-IA - Dataset ML V6 - README pour le coequipier ML

## Version : v6.0
## Fichier : ml_dataset_v6.csv
Genere par `python pipeline.py` - Avril 2026
...
```
  ...
  slope_std                           [SLOPE]
  twi_mean                            [HYDROLOGY]
  has_thalweg_mean                    [HYDROLOGY]
  profile_curvature_mean              [MORPHOLOGY]
  tri_mean                            [MORPHOLOGY]
  hillshade_winter_mean               [SUNLIGHT]
  aspect_south_ratio_mean             [SUNLIGHT]
  svf_mean                            [SUNLIGHT]
```
...
## Colonne block_id
  Identifiant bloc spatial (grille 300m) - OBLIGATOIRE pour GroupKFold
...
## Fichier SHAP par parcelle : shap_par_parcelle_v6.csv
